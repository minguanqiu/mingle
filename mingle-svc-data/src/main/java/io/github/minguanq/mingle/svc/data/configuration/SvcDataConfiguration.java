package io.github.minguanq.mingle.svc.data.configuration;

import com.fasterxml.jackson.databind.DeserializationFeature;
import com.fasterxml.jackson.databind.ObjectMapper;
import com.fasterxml.jackson.databind.SerializationFeature;
import io.github.minguanq.mingle.svc.data.aspect.DaoLogAspect;
import io.github.minguanq.mingle.svc.data.configuration.properties.SvcDataProperties;
import io.github.minguanq.mingle.svc.data.handler.DaoLoggingHandler;
import io.github.minguanq.mingle.svc.data.handler.impl.DaoLoggingHandlerDefaultImpl;
