...
public class SvcFeatureRegisterImpl implements SvcFeatureRegister<SvcFeature> {
    ...
    private SvcFeature buildFeature(SvcRegister.SvcDefinition svcDefinition) {
        ...
        io.github.minguanqiu.mingle.svc.annotation.SvcFeature svcFeatureAnnotation = svcDefinition.getSvcClass().getAnnotation(io.github.minguanqiu.mingle.svc.annotation.SvcFeature.class); //second setting
