...
import io.github.minguanqiu.mingle.svc.SimpleSvcWithFeature;
...
public class SvcFeatureTests {
    ...
    void beforeTest() throws Exception {
        perform = mockMvc.perform(SvcTestUtils.buildSvcRequest(svcPathHandler, SimpleSvcWithFeature.class).content(SvcTestUtils.getTestContent("normal", "Hello", "World")));
    }
