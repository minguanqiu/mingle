...
public class SvcAuthenticationFilter extends OncePerRequestFilter {
  ...
  public SvcAuthenticationFilter(SvcRegister svcRegister, SvcSessionProperties svcSessionProperties,
      SvcSessionDao svcSessionDao, SessionHandler sessionHandler,
  ...
  protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response,
    ...
    SvcSessionEntity sessionEntity = sessionHandler.getSession(plainText);
    ...
    sessionHandler.afterAuthentication(sessionEntity);
